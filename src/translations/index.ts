...
export const gl = {
  ...
  // Hero
  heroTitle: 'Valoració confidencial para empresas de 1-10M€ de facturación anual',
  ...
  servicesSubtitle: 'Servizos especializados para empresas con facturación entre 1 e 10 millóns de euros, enfocados en processos de venda por jubilació ou successió.',
  businessValuation: 'Valoración confidencial',
  ...
  aboutUsDescription: 'En Valor España especializámonos en empresas con facturación entre 1 e 10 millóns de euros, cuxos propietarios están a considerar unha venda por jubilació ou planificación de successió. O noso proceso garante total confidencialidade en cada etapa.',
