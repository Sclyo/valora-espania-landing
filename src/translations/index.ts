...
export const gl = {
  ...
  servicesSubtitle: 'Servizos especializados para empresas con facturación entre 2 e 10 millóns de euros, enfocados en processos de venda por jubilació ou successió.',
  businessValuation: 'Valoración confidencial',
  ...
  aboutUsDescription: 'En Valor España especializámonos en empresas con facturación entre 2 e 10 millóns de euros, cuxos propietarios están a considerar unha venda por jubilació ou planificación de successió. O noso proceso garante total confidencialidade en cada etapa.',
  ...
  methodologyDescription: 'Proceso especializado para empresas en fase de successió ou venda por jubilación:',
  ...
  multipleValuation: '2. Valoración por múltiples',
  multipleValuationDesc: 'Comparativas específicas para empresas de 2-10M€ en processos de successió ou venda.',
...
export const eu = {
  ...
  aboutUsDescription: 'Valor España-n, 2 eta 10 milioi euro arteko fakturazioa duten enpresetan espezializatzen gara, jabeak erretiroarengatik edo ondorengotza-plangintzagatik salmenta bat kontuan hartzen ari direnak. Gure prozesuak konfidentzialtasun osoa bermatzen du etapa guztietan.',
  ...
  customizedApproach: '2-10M€ fakturatzen duten ETEentzako ikuspegia',
  customizedApproachDesc: '2 eta 10 milioi arteko fakturazioa duten negozioetarako berariazko konponbideak, sektore eta egoera bakoitzera egokituta.',
  ...
  multipleValuationDesc: 'Konparazio espezifikoak ondorengotza edo salmenta prozesuetan dauden 2-10M€-ko enpresentzat.',
