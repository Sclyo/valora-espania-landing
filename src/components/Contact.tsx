    ...
    <section id="contacto" className="section-padding bg-gray-50">
      <div className="container-fluid">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <h2 className="heading-lg text-valoraBurgundy mb-6">Hablemos sobre el valor de su empresa</h2>
            ...
            <div className="space-y-6 text-gray-700">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-valoraBurgundy flex items-center justify-center mr-4">
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-valoraBurgundy mb-6">Solicite información</h3>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-valoraBurgundy hover:bg-valoraBurgundy-light text-white py-6"
